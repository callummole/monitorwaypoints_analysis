...
class Offline_Surface_Tracker(Surface_Tracker):
    ...
    def __init__(self,g_pool,mode="Show Markers and Surfaces",min_marker_perimeter = 40,invert_image=False,robust_detection=True):
    ...
    def load_surface_definitions_from_file(self):
        #print ("surface definitions called")
